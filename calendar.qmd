...
This is an example of embedding a calendar widget with multiple calendars:
...
You can embed many kinds of websites in this one. This example just happens to be a Google Calendar.

## Create and Embed Multiple Google Calendars into a Single View

These instructions document how to create calendars and generate a single embedable URL for them. This might be useful if you want to have different calendars for assignments, exams, instructor office hours, GSI office hours, etc.
...
4. **Create a Single Embed Link:**
   ...
   You can replace the value of the `src` attribute in the iframe element above with this URL.
